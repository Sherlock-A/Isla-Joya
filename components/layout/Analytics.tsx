...
/**
 * Marketing tags — Meta Pixel, GA4, GTM, TikTok Pixel.
 * Each only loads when its NEXT_PUBLIC_* id is configured, so nothing
 * ships in development or before the client provides their ids.
 */
